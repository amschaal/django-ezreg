...
def complete_refund(request, id):
    ...
    return render(request, 'ezreg/registration.html', {'registration':refund.registration, 'permissions': permissions, 'message': "Refund request has been completed."})
...
def cancel_refund(request, id):
    ...
    permissions = refund.registration.event.get_user_permissions(request.user) if request.user.is_authenticated else []
    return render(request, 'ezreg/registration.html', {'registration':refund.registration, 'permissions': permissions, 'message': "Refund request has been cancelled."})
