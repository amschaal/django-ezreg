...
class UCPaymentProcessor(BasePaymentProcessor):
    ...
    exportable_fields = OrderedDict([('uc','UC'),('account','Account'),('financial_contact_first_name','Financial Contact First Name'),('financial_contact_last_name','Financial Contact Last Name'),('financial_contact_email','Financial Contact Email'),('financial_contact_phone','Financial Contact Phone'),('pi_first_name','PI First Name'),('pi_last_name','PI Last Name'),('pi_email','PI Email')])
    @staticmethod
