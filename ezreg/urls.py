...
from ezreg.api.views import PriceViewset
...
urlpatterns = [
    ...
    url(r'^events/(?P<slug_or_id>[A-Za-z0-9_\-]{5,100})/register/$', RegistrationWizard.as_view([RegistrationForm, PriceForm]), name="register"),
